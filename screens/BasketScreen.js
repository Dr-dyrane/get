  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        <View className="p-5 border-b border-[#9B26AF] bg-white shadow-sm">
          <View>
          ...
          >
            <XCircleIcon color="#9B26AF" size={50} />
          </TouchableOpacity>
        </View>
        ...
        <View className="flex-row items-center space-x-4 px-4 py-3 bg-white my-5">
          ...
          <TouchableOpacity>
            <Text className="text-[#9B26AF]">Change</Text>
          </TouchableOpacity>
        </View>
        <ScrollView className="divide-y divide-gray-200">
          {Object.entries(groupedItemsInBusket).map(([key, items]) => (
            ...
            >
              <Text className="text-[#9B26AF]">{items.length} x</Text>
              <Image
                source={{
        ...
        <View className="p-5 bg-white mt-5 space-y-4">
          ...
          <TouchableOpacity
            ...
            className="rounded-lg bg-[#9B26AF] p-4"
          >
